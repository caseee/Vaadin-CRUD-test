 ...
 *
 */
public class SizesView extends AbstractSingleTableManagerView {

	public static String NAME = "sizes";
	private List<ViewPropertyId> ListOfViewPropertyId;
	private static final long serialVersionUID = -2761194119116051272L;
	...
	public SQLContainer getSQLContainer() {
		return VaadinSession.getCurrent().getAttribute(Controller.class).getSizesContainer();
	}
