...
//		editorFields.bind(totalLabel, "TOTAL");
	...
	synchronized private void evaluateTotal() {
		...
		totalLabel.setValue(total.toString());
	...
	public void enter(ViewChangeEvent event) {
		...
		if(parameters != null){
			...
			try { 
				...
				if (msgs.length == 2) {
					headID=Integer.parseInt(msgs[1]);
	...
	private GridLayout buildGridLayout_2() {
		...
		totalLabel.setCaption("Total:");
		totalLabel.setImmediate(false);
		totalLabel.setWidth("-1px");
		totalLabel.setHeight("-1px");
		totalLabel.setValue("0");
		gridLayout_2.addComponent(totalLabel, 3, 3);
		gridLayout_2.setComponentAlignment(totalLabel, new Alignment(6));
