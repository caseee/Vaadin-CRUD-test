...
//		}
	...
	private GridLayout buildGridLayout_2() {
		...
		// changeQuantity
		changeQuantity = new Button();
		changeQuantity.setCaption("Change Quantity");
		changeQuantity.setImmediate(true);
		changeQuantity.setWidth("100.0%");
		changeQuantity.setHeight("-1px");
		gridLayout_2.addComponent(changeQuantity, 2, 3);
