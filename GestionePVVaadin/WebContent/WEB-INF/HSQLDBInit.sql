...
CREATE TABLE USERS (ID IDENTITY, USER VARCHAR(255) UNIQUE NOT NULL, PASS VARCHAR(255) NOT NULL, LEVEL INT NOT NULL); 
CREATE TABLE GROUPS (ID IDENTITY, FATHER_ID INTEGER REFERENCES GROUPS (ID), DESCRIPTION CHAR(256) );
